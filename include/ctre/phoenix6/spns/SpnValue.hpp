    ...
    namespace phoenix6
    {
        namespace spns
        {
            ...
            public:
                ...
                static constexpr int ExternalMotorTempStatus = 2056;
                static constexpr int ExternalMotorTemp = 2057;
                ...
                static constexpr int Config_AdvancedHallSupport = 2617;
                static constexpr int Config_MotorType = 2618;
                static constexpr int CANdi_Pin1State = 2677;
                static constexpr int CANdi_Pin2State = 2678;
                static constexpr int CANdi_QuadPosition = 2679;
                static constexpr int CANdi_Pwm1_RiseToRise = 2685;
                static constexpr int CANdi_Pwm1_Position = 2686;
                static constexpr int CANdi_Pwm1_Velocity = 2688;
                static constexpr int CANdi_Pwm2_RiseToRise = 2689;
                static constexpr int CANdi_Pwm2_Position = 2690;
                static constexpr int CANdi_Overcurrent = 2692;
                static constexpr int CANdi_VSense = 2693;
                static constexpr int CANdi_OutputCurrent = 2694;
                static constexpr int CANdi_S1FloatState = 2695;
                static constexpr int CANdi_S2FloatState = 2696;
                static constexpr int Config_AbsoluteSensorOffset = 2705;
                static constexpr int Config_ExternalFeedbackSensorSource = 2706;
                static constexpr int Config_SensorPhase = 2707;
                static constexpr int Config_QuadratureEdgesPerRotation = 2708;
                static constexpr int Config_AbsoluteSensorDiscontinuityPoint = 2709;
                static constexpr int CANdi_Pwm2_Velocity = 2847;
                static constexpr int TalonFXS_5VRailVoltage = 2849;
                static constexpr int TalonFXS_Gadgeteer_G3 = 2850;
                static constexpr int CANdi_QuadVelocity = 2857;
                static constexpr int Config_PWM1_AbsoluteSensorOffset = 2858;
                static constexpr int Config_PWM1_AbsoluteSensorDiscontinuityPoint = 2859;
                static constexpr int Config_PWM1_SensorDirection = 2860;
                static constexpr int Config_PWM2_AbsoluteSensorOffset = 2862;
                static constexpr int Config_PWM2_AbsoluteSensorDiscontinuityPoint = 2863;
                static constexpr int Config_PWM2_SensorDirection = 2864;
                static constexpr int Config_Quad_SensorDirection = 2866;
                static constexpr int CANdi_SetQuadPosition = 2868;
                static constexpr int Config_S1_CloseState = 2869;
                static constexpr int Config_S2_CloseState = 2870;
                static constexpr int CANdi_S1Closed = 2871;
                static constexpr int CANdi_S2Closed = 2872;
                static constexpr int Config_BrushedMotorWiring = 2878;
                static constexpr int PRO_GadgeteerQuad_RawQuadraturePosition = 2885;
                static constexpr int PRO_GadgeteerQuad_RawQuadratureVelocity = 2886;
                static constexpr int PRO_GadgeteerPwm_RawPwmPosition = 2887;
                static constexpr int PRO_GadgeteerPwm_RawPwmVelocity = 2888;
                ...
                static constexpr int Fault_CANDI_5V = 10118;
                static constexpr int StickyFault_CANDI_5V = 10119;
                static constexpr int ClearStickyFault_CANDI_5V = 10120;
                ...
                */
                std::string GetUnits() const
                {
                    ...
                    case SpnValue::ExternalMotorTempStatus: return "";
                    ...
                    case SpnValue::Config_AdvancedHallSupport: return "";
                    case SpnValue::Config_MotorType: return "";
                    case SpnValue::CANdi_Pin1State: return "";
                    case SpnValue::CANdi_Pin2State: return "";
                    ...
                    case SpnValue::CANdi_Overcurrent: return "";
                    case SpnValue::CANdi_VSense: return "V";
                    case SpnValue::CANdi_OutputCurrent: return "A";
                    case SpnValue::CANdi_S1FloatState: return "";
                    case SpnValue::CANdi_S2FloatState: return "";
                    case SpnValue::Config_AbsoluteSensorOffset: return "rotations";
                    case SpnValue::Config_ExternalFeedbackSensorSource: return "";
                    case SpnValue::Config_SensorPhase: return "";
                    case SpnValue::Config_QuadratureEdgesPerRotation: return "";
                    ...
                    case SpnValue::Config_PWM1_SensorDirection: return "";
                    ...
                    case SpnValue::Config_PWM2_SensorDirection: return "";
                    case SpnValue::Config_Quad_SensorDirection: return "";
                    case SpnValue::CANdi_SetQuadPosition: return "rotations";
                    case SpnValue::Config_S1_CloseState: return "";
                    case SpnValue::Config_S2_CloseState: return "";
                    case SpnValue::CANdi_S1Closed: return "";
                    case SpnValue::CANdi_S2Closed: return "";
                    case SpnValue::Config_BrushedMotorWiring: return "";
                    ...
                    case SpnValue::Fault_TALONFX_BridgeShort: return "";
                    case SpnValue::StickyFault_TALONFX_BridgeShort: return "";
                    case SpnValue::ClearStickyFault_TALONFX_BridgeShort: return "";
                    case SpnValue::Fault_TALONFX_HallSensorMissing: return "";
                    case SpnValue::StickyFault_TALONFX_HallSensorMissing: return "";
                    case SpnValue::ClearStickyFault_TALONFX_HallSensorMissing: return "";
                    case SpnValue::Fault_TALONFX_DriveDisabledHallSensor: return "";
                    case SpnValue::StickyFault_TALONFX_DriveDisabledHallSensor: return "";
                    case SpnValue::ClearStickyFault_TALONFX_DriveDisabledHallSensor: return "";
                    case SpnValue::Fault_TALONFX_MotorTempSensorMissing: return "";
                    case SpnValue::StickyFault_TALONFX_MotorTempSensorMissing: return "";
                    case SpnValue::ClearStickyFault_TALONFX_MotorTempSensorMissing: return "";
                    case SpnValue::Fault_TALONFX_MotorTempSensorTooHot: return "";
                    case SpnValue::StickyFault_TALONFX_MotorTempSensorTooHot: return "";
                    case SpnValue::ClearStickyFault_TALONFX_MotorTempSensorTooHot: return "";
                    case SpnValue::Fault_CANDI_5V: return "";
                    case SpnValue::StickyFault_CANDI_5V: return "";
                    case SpnValue::ClearStickyFault_CANDI_5V: return "";
                    default:
                        return "Invalid Value";
                    }
                }
                ...
                */
                std::string GetSummary() const
                {
                    ...
                    case SpnValue::Config_AbsoluteSensorOffset: return "The offset applied to any absolute sensor connected to the Talon data port.  This is only supported when using the PulseWidth sensor source.\nThis can be used to zero the sensor position in applications where the sensor is 1:1 with the mechanism.";
                    ...
                    case SpnValue::Config_PWM1_AbsoluteSensorOffset: return "The offset applied to the PWM sensor.\nThis can be used to zero the sensor position in applications where the sensor is 1:1 with the mechanism.";
                    case SpnValue::Config_PWM1_AbsoluteSensorDiscontinuityPoint: return "The positive discontinuity point of the absolute sensor in rotations. This determines the point at which the absolute sensor wraps around, keeping the absolute position in the range [x-1, x). <list><item>Setting this to 1 makes the absolute position unsigned [0, 1) <item>Setting this to 0.5 makes the absolute position signed [-0.5, 0.5) <item>Setting this to 0 makes the absolute position always negative [-1, 0)</list> Many rotational mechanisms such as arms have a region of motion that is unreachable. This should be set to the center of that region of motion, in non-negative rotations. This affects the position of the device at bootup.";
                    ...
                    case SpnValue::Config_PWM2_AbsoluteSensorOffset: return "The offset applied to the PWM sensor.\nThis can be used to zero the sensor position in applications where the sensor is 1:1 with the mechanism.";
                    case SpnValue::Config_PWM2_AbsoluteSensorDiscontinuityPoint: return "The positive discontinuity point of the absolute sensor in rotations. This determines the point at which the absolute sensor wraps around, keeping the absolute position in the range [x-1, x). <list><item>Setting this to 1 makes the absolute position unsigned [0, 1) <item>Setting this to 0.5 makes the absolute position signed [-0.5, 0.5) <item>Setting this to 0 makes the absolute position always negative [-1, 0)</list> Many rotational mechanisms such as arms have a region of motion that is unreachable. This should be set to the center of that region of motion, in non-negative rotations. This affects the position of the device at bootup.";
